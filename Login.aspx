<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Monica_Project.Login" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style11">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="BuCancel" runat="server" CssClass="newStyle3" Text="Cancel" OnClick="BuCancel_Click" />
                        <br />
                        <br />
                        <br />
                        <br />
